...
//       res.status(200).json({ success: true, message: "Users retrieved successfully", data: userData });
//     } else {
...
//     if (userData) {
//       const { password, ...others } = userData._doc;
//       res.status(200).json({ success: true, message: "User retrieved successfully", data: [others] });
//     } else {
//       res.status(200).json({ success: true, message: "No Data Found!", data: [] });
//     }
//   } catch (err) {
